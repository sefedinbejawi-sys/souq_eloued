...
-- التسجيل المباشر: الاسم والهاتف والبريد وكلمة السر
...
begin
  ...
  values (new.id, new_org_id, coalesce(new.email, ''), display_name, nullif(new.raw_user_meta_data ->> 'phone', ''), 'viewer', false, false)
